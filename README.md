...
1. Set proxies by typing: 
  - [npm config set https_proxy http://PITC-Zscaler-Global-ZEN.proxy.corporate.ge.com:80]
  - [npm config set proxy http://PITC-Zscaler-Global-ZEN.proxy.corporate.ge.com:80]
  - [npm config set https-proxy http://PITC-Zscaler-Global-ZEN.proxy.corporate.ge.com:80]
  - [npm config set http_proxy http://PITC-Zscaler-Global-ZEN.proxy.corporate.ge.com:80]
  - [npm config set python "c:\Python\27\python.exe"]
  - [npm set strict-ssl false]
1. Install windows distro packages [npm install -g --production windows-build-tools]  This can take awhile
